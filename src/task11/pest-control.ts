import { MsgError, MsgHello, MsgSiteVisit, Payload, msgType } from './msg';
    ...
    async _transform(data: Payload, _: BufferEncoding, done: TransformCallback) {
        ...
        if (this.expect === msgType.hello) {
            ...
            try {
                ...
                log.info(
                    `pestcontrol: site:${observed.site}, observed populations`,
                ...
                log.info(`pestcontrol: site:${observed.site}, target populations`, JSON.stringify(target.populations));
