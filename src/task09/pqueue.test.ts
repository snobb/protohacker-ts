...
describe("pqueue", () => {
  ...
  describe("enque/deque", () => {
    test("should add jobs in random order and deque in order", () => {
      const input = [1, 7, 15, 3, 87, 101];
      const exp = [...input].sort((a, b) => a - b).reverse();
    ...
    test("should add jobs in random order and deque in order after delete", () => {
      const input = [1, 7, 15, 3, 87, 101];
      const exp = [...input]
          .sort((a, b) => a - b)
          .reverse();
    ...
    test('should delete a job with given ID from the queue', () => {
      const input = [1, 7, 15, 3, 87, 101];
      const exp = [...input]
          .sort((a, b) => a - b)
          .reverse();
