...
describe("code-store tests", () => {
  ...
  describe('get/put tests', () => {
    ...
    test('should add value to the store', () => {
    ...
    test('should add value multiple times and get different revisions', () => {
  ...
  describe('list tests', () => {
    ...
    test("should list files and folders correctly in the root", () => {
    ...
    test("should list files and folders correctly in the /foo folder", () => {
    ...
    test("should list files and folders correctly in the bar folder", () => {
    ...
    test("should not return anything for /baz because it's a file", () => {
